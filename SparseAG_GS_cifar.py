...
def main():
    ...
    mean_reduce = float(total_reduce) / length
    mean_norm_inf = float(total_norm_inf) / length
    mean_norm_2 = float(total_norm_2) / length
    mean_norm_1 = float(total_norm_1) / length
    mean_group = [item / length for item in total_group]
    mean_nrom_0 = float(total_norm_0) / length
    mean_running_time = float(total_time) / length
    filename = 'result.txt'
    with open(filename, 'a') as file_object:
        file_object.write('-----------NON-TARGET Group Sparse VGG16-----------')
        ...
        file_object.write('The length and success are : ' + str(length) + ' ' + str(success) + '\n')
        file_object.write('The average running time is  : ' + str(mean_running_time) + '\n')

    print('The average pert num are :', mean_reduce)
